export default {
  ...
  projects: [
    ...
    },
    {
      ...
      links: [
        {
          url: 'https://github.com/roopeshshettyb/NexWordCloud',
          text: 'View source code',
        }, {
          url: 'https://nex-word-cloud.vercel.app/',
          text: 'Demo',
        },
      ],
      technologies: [
    ...
    },
    {
      ...
      links: [
        {
          url: 'https://github.com/roopeshshettyb/ChurroBackend',
          text: 'View source code',
        },
      ],
      technologies: [
    ...
    },
    {
      ...
      links: [
        {
          url: 'https://github.com/roopeshshettyb/BurritoBackend',
          text: 'View source code',
        },
      ],
      technologies: [
    ...
    },
    {
      ...
      links: [
        {
          url: 'https://github.com/roopeshshettyb/Pizza',
          text: 'View source code',
        },
      ],
      technologies: [
    ...
    },
    {
      ...
      links: [
        {
          url: 'https://github.com/roopeshshettyb/TacoFrontend',
          text: 'source code (Frontend)',
        },
        {
          url: 'https://github.com/roopeshshettyb/TacoBackend',
  ...
  hobbies: [
    ...
    },
    {
      name: 'Movies',
      icon: 'movie',
      description: 'Thrillers are my favourite',
    },
    {
      name: 'Video Games',
      icon: 'games',
      description: 'Sometimes I make a million dollars in these so',
    },
    {
      name: 'Saving Time',
      icon: 'hourglass_empty',
      description: 'for myself and others by optimizing stuff',
    },
    {
      name: 'Music',
      icon: 'music_note',
